...
DEFAULT_CHART_RELEASER_VERSION=v1.6.4
...
install_chart_releaser() {
  ...
  if [[ ! -d "$install_dir" ]]; then
    ...
    curl -sSLo cr.tar.gz "https://github.com/sk91/chart-releaser/releases/download/$version/chart-releaser_${version#v}_linux_amd64.tar.gz"
